// Full Nigeria state -> LGA mapping (36 states + FCT).
// Source: aggregated public datasets (GitHub gist) and Wikipedia. :contentReference[oaicite:1]{index=1}
export const NIGERIA_LOCATIONS: Record<string, string[]> = {
  "Abia": [
    "Aba North","Aba South","Arochukwu","Bende","Ikwuano",
    "Isiala-Ngwa North","Isiala-Ngwa South","Isuikwuato","Obi Nwa",
  ...
  "Ebonyi": [
    "Abakaliki","Afikpo North (Edda)","Afikpo South (Edda)","Ebonyi","Ezza","Ezza South",
  ...
  "Ekiti": [
    "Ado Ekiti","Efon","Ekiti East","Ekiti South-West","Ekiti West","Emure/Ise/Orun",
    "Gbonyin (Akoko-Edo)", "Ido/Osi","Ikere","Ilejemeje","Irepodun/Ifelodun","Ijero",
    "Ikole","Moba","Oye"
  ],
  "Enugu": [
    ...
    "Oji River","Udenu","Uzo-Uwani"
  ],
  "Gombe": [
    "Akko","Balanga","Billiri","Dukku","Funakaye","Gombe","Kaltungo","Kwami",
    "Nafada/Bajoga","Shongom","Yamaltu/Deba"
  ],
  "Imo": [
    "Aboh Mbaise","Ahiazu Mbaise","Ehime Mbano","Ezinihitte","Ideato North",
    "Ideato South","Ihitte/Uboma","Ikeduru","Isiala Mbano","Isu","Mbaitoli",
    "Ngor Okpala","Njaba","Nwangele","Nkwerre","Obowo","Oguta","Ohaji/Egbema",
    "Okigwe","Orlu","Orsu","Oru East","Oru West","Owerri Municipal","Owerri North","Owerri West"
  ],
  "Jigawa": [
    "Auyo","Babura","Birni Kudu","Birniwa","Biu?","Buhari?","Buji","Dutse","Gagarawa",
    "Garki","Gumel","Guri","Gwaram","Gwiwa","Hadejia","Jahun","Kafin Hausa","Kazaure",
    "Kiri Kasamma","Kiyawa","Maigatari","Malam Madori","Miga","Ringim","Roni","Sule Tankarkar",
    "Taura","Yankwashi"
  ],
  "Kaduna": [
    "Birnin Gwari","Chikun","Giwa","Igabi","Ikara","Jaba (Ifarka)","Jema'a","Kachia",
  ...
  "Kano": [
    ...
    "Gwale","Gwarzo","Kabo","Kano Municipal","Kumbotso","Kunchi","Kura","Madobi","Makoda",
  ...
  "Kwara": [
    "Asa","Baruten","Edu","Ekiti (Isin)","Ilorin East","Ilorin South","Ilorin West",
  ...
  "Ogun": [
    ...
    "Ijebu North East","Ijebu Ode","Ikenne","Imeko Afon","Ipokia","Obafemi-Owode","Odogbolu",
    "Odeda","Ogun Waterside","Remo North","Shagamu"
  ],
  "Ondo": [
  ...
  "Osun": [
    ...
    "Ife South","Ifedayo","Ila","Ilesa East","Ilesa West","Irepodun","Irewole","Isokan",
  ...
  "Plateau": [
    "Bokkos","Bassa","Barkin Ladi","Bokkos","Jos East","Jos North","Jos South","Kanam",
  ...
  "Rivers": [
    ...
    "Oyigbo","Opobo/Nkoro","Bonny","Andoni","Degema","Asari-Toru","Akuku-Toru",
    "Abua-Odual","Ahoada East","Ahoada West","Ogba/Egbema/Ndoni","Emohua","Ikwerre",
    "Etche","Omuma"
  ],
  "Sokoto": [
    "Binji","Bodinga","Dange Shuni","Gada","Goronyo","Gudu","Gwadabawa","Illela",
    "Kebbe","Kware","Rabah","Sabon Birni","Shagari","Sokoto North","Sokoto South","Tambuwal",
    "Tangaza","Tureta","Wammako","Wurno","Yabo"
  ],
  "Taraba": [
  ...
  "FCT": [
    "Abaji","Abuja Municipal (Municipal)","Bwari","Gwagwalada","Kuje","Kwali"
  ]
};
